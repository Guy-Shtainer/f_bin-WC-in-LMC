...
| 1 | CDF truncation at 350 km/s | Investigate truncating the CDF at ~350 km/s where observation gaps begin — may improve K-S fit | high | bias-correction | open | Claude | Tomer | 2026-03-01 | N | Y |
| 4 | Langer 2020 period model | Implement pipeline/langer_grid.py for the Langer et al. (2020) period distribution model | high | bias-correction, pipeline | open | Claude | Tomer | 2026-03-01 | N | Y |
| 2 | Duplicate Dsilva/Langer tabs | Add ability to duplicate parameter tabs for side-by-side exploration of different grid configurations | high | bias-correction, webapp | open | Claude | Tomer | 2026-03-01 | N | Y |
| 20 | Switch to matplotlib-style Plotly theming | White backgrounds, scientific fonts, traditional academic plot styling via Plotly (not pure matplotlib) | high | graphs, webapp | open | Claude | Guy | 2026-03-01 | N | Y |
| 21 | Fix broken Plots page — implement from notebook | Implement all available plots from Plots.ipynb and StarClass.py plot methods in the webapp | high | webapp, plots | open | Claude | Guy | 2026-03-01 | N | Y |
| 22 | Create NRES analysis page | New page for NRES spectra: stitching, blaze correction, CCF on emission lines, RV std threshold determination | high | webapp, NRES | open | Claude | Guy | 2026-03-01 | N | Y |
| 23 | Statistical RV modeling page | New page: model f_bin vs threshold by simulating RV pulls from binary orbital distributions and single-star Gaussians (from Thesis work.ipynb cells 83-89) | high | bias-correction, stats | open | Claude | Guy | 2026-03-01 | N | Y |
| 24 | Set up Overleaf/LaTeX paper structure | Create paper/ directory with A&A format LaTeX skeleton, sync instructions for Overleaf, start drafting sections from DOCUMENTATION.md | high | paper | open | Claude | Guy | 2026-03-01 | N | Y |
| 25 | Remove duplicate page menu in sidebar | Top page menu is ugly but functional, bottom one looks great — remove the top duplicate | medium | GUI, webapp | open | Claude | Guy | 2026-03-01 | Y | N |
...
| 7 | Publication-quality figures | Generate final plots for thesis/paper — CDF comparison, corner plot, orbital params | medium | paper, plots | open | Claude | Guy | 2026-03-01 | N | Y |
| 31 | Create project status dashboard page | Documentation of all plots and calculations, track implementation status (working, bugs, planned, not started) with interactive checklist | low | webapp, global | open | Claude | Guy | 2026-03-01 | N | N |
