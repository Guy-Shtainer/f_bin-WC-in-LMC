"""
todo_core.py — Shared TODO logic and UI rendering.

Used by both app/pages/10_todo.py (embedded page) and todo_app.py (standalone).
All task data lives in TODO.md at the project root.
"""
...
def render_todo_page() -> None:
    """Render the full TODO page UI. Call after st.set_page_config() and theme injection."""
