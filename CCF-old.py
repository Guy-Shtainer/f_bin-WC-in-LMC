        ...
        for i, (ep, w, f) in enumerate(obs_list):
            if ep in skip_clean_epochs:
              ...
              self.star_name == 'HD 269888' and (self.line_tag == "He II 5412 & C IV 5471")):
                ...
                if self.star_name == "Brey  90a" and (self.line_tag == "C IV 3650-3900" or self.line_tag == "C III 6700-6800" or self.line_tag == "He II 5412 & C IV 5471" or self.line_tag == "C IV 7063" or self.line_tag == "C IV 17396"):
                    clean_absorption = False
