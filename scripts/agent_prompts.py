...
AGENT_ROLES: dict[str, dict] = {
    ...
    'reviewer': {
        'system_prompt': (
            ...
            "## What's Correct\n"
            "- List specific things the plan does right\n\n"
            "## What Needs Fixing\n"
            "- List specific issues with the plan (if any)\n"
            "- If nothing needs fixing, say so\n\n"
            "## Corrections Required\n"
            "- Exact changes needed to fix each issue (if any)\n\n"
            "When reviewing a REVISED plan (replan round), also check:\n"
            "- Were the previous issues actually corrected?\n"
            "- Were the correct parts preserved unchanged?\n"
            ...
            "- REJECTED — plan has critical issues that must be fixed\n\n"
